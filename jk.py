...
def figury_plaskie():
    ...
    if wybor == "a":
        r = get_float("Promień: ")
        print("Pole koła:", round(math.pi * r**2, 2))
        print("Obwód koła:", round(2 * math.pi * r, 2))
    elif wybor == "b":
        a = get_float("Bok: ")
        print("Pole kwadratu:", round(a**2, 2))
        ...
        print("Nieprawidłowy wybór figury.")
...
def bryly():
    ...
    if wybor == "a":
        a = get_float("Bok: ")
        print("Pole powierzchni sześcianu:", round(6 * a**2, 2))
        print("Objętość sześcianu:", round(a**3, 2))
    elif wybor == "b":
        a = get_float("Bok a: ")
        b = get_float("Bok b: ")
        c = get_float("Bok c: ")
        print("Pole powierzchni prostopadłościanu:", round(2 * (a * b + a * c + b * c), 2))
        ...
        print("Objętość walca:", round(math.pi * r**2 * h, 2))
    elif wybor == "d":
        r = get_float("Promień: ")
        print("Pole powierzchni kuli:", round(4 * math.pi * r**2, 2))
        print("Objętość kuli:", round((4/3) * math.pi * r**3, 2))
    elif wybor == "e":
        r = get_float("Promień podstawy: ")
        h = get_float("Wysokość: ")
        l = math.sqrt(r**2 + h**2)
        print("Pole powierzchni stożka:", round(math.pi * r * (r + l), 2))
        print("Objętość stożka:", round((1/3) * math.pi * r**2 * h, 2))
    elif wybor == "f":
